...
function FeedbackBySender(props) {
    ...
    return(
        <div>
            <p>Средний рейтинг:  {senderAvgRating === null ? '-' : Math.round(senderAvgRating * 10)/10 }/5</p>
            <CardColumns>
...
function FeedbackByDeliverer(props) {
    ...
    return(
        <div>
            <p>Средний рейтинг:  {delivererAvgRating === null ? '-' : Math.round(delivererAvgRating *10)/10}/5</p>
            <CardColumns>
...
function ViewFeedbackUser(props) {
    ...
    return (
        <div className="container" style={{paddingTop: '10px', paddingBottom: '10px'}}>
            <h2>Отзывы от предыдущих заказов</h2>
            <hr></hr>
        
            <strong>Отзывы отправителей</strong>
            <FeedbackBySender userid={currentuserid} />
            <strong>Отзывы доставщиков</strong>
