...
const PickUpComplete = ({ jobid, jobstatus }) => {
    ...
    if(currentjobstatus === "accepted") {
        return <Button onClick={PickUp} variant="success" type="submit">Получено</Button>
    } else { // status == inProgress
        return <Button onClick={MarkComplete} variant="success" type="submit">Выполнено!</Button>
    }
}
