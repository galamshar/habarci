...
const statusCheck = {
  accepted : 'Принято (не выдано)', // not picked up
            ...
            <Row>
              <Col md="3" style={{textAlign:'left'}}>
                <Card text="white" bg="info" border="info" style={{ width: '14rem' }} >
                  <Card.Body>
                    <Card.Title>О доставщике:</Card.Title>
                    <Card.Text>{ `Имя: ${row.delivererName}`}</Card.Text>
                    <Card.Text>{ `Контакт:  ${row.delivererContactNo}`}</Card.Text>
                  </Card.Body>
                </Card>     
              </Col>
            </Row>
